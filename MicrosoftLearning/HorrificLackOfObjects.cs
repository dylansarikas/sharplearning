...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                string findAge = ourAnimals[i, 2][^1].ToString();
                if (ourAnimals[i, 0] != "ID #: " && !int.TryParse(findAge, out int _))
                {
                    Console.WriteLine($"Valid Pet Found with invalid age {ourAnimals[i, 0]}");
                    bool validEntryThree = false;
                    do
                    {
                ...
                {
                    Console.WriteLine($"Valid Pet Found with invalid desc {ourAnimals[i, 0]}");
                    readResult = Console.ReadLine();
                    ourAnimals[i, 4] = "Physical description: " + readResult;
                }

            }
            Console.WriteLine("Every pet age and description accounted for!");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    Console.WriteLine($"Valid pet with invalid nickname found {ourAnimals[i, 0]}");
                ...
                {
                    Console.WriteLine($"Valid pet with invalid personality found {ourAnimals[i, 0]}");
                    bool validPersonality = false;
                    do
                    {
                        Console.WriteLine("Please enter a valid personality: ");
                        readResult = Console.ReadLine();
                        if (readResult != "")
                        {
